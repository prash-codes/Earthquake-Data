...
if __name__ == '__main__':
    ...
    blob = bucket.blob('Historical_data_pyspark/bronze_layer/raw_data')  # Specify the path in the bucket
    ...
    # parquet_output_path = f"gs://earth_earthquake_data/Historical_data_pyspark/silver/{current_date}/PQ_flatten_data"
    # flattened_df.coalesce(1).write.parquet(parquet_output_path)

    # ---------------------------------------------------------------------------------------------------------------------------------

    # Read data from silver.parquet file
    parquet_file_path = (r"gs://earth_earthquake_data/Historical_data_pyspark/silver/20241123/PQ_flatten_data/part"
                         r"-00000-89a8640b-e09a-44e5-aa07-bd903dafcbc5-c000.snappy.parquet")
    ...
    pq_df2.write.format("bigquery") \
        .option("table", "earthquake-project-442611.earthquake_dataset.Historical_data_table") \
